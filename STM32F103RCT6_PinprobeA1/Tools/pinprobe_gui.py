...
SCPI_COMMANDS = {
    ...
    "控制模式": [
        ("本地模式", "CONFigure:MODE LOCAL"),
        ("远程模式", "CONFigure:MODE REMOTE"),
        ("混合模式", "CONFigure:MODE MIXED"),
        ("读控制模式", "READ:MODE?"),
        ("模式切换 ON", "CONFigure:MODE:ENABle ON"),
        ("模式切换 OFF", "CONFigure:MODE:ENABle OFF"),
        ("读模式切换", "READ:MODE:ENABle?"),
    ],
    "急停": [
...
SCPI_LABEL_EN = {
    ...
    "远程模式": "Remote Mode",
    "混合模式": "Mixed Mode",
    "读控制模式": "Read Control Mode",
    "模式切换 ON": "Mode Enable ON",
    "模式切换 OFF": "Mode Enable OFF",
    "读模式切换": "Read Mode Enable",
    "常闭 NC (默认)": "NC (Default)",
    "常开 NO": "NO",
